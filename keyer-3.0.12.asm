...
write_eeprom_blowout
	...
	bcf EECON1, WREN	; clear write enable falg
...
main_loop
	...
	; TODO - add some kind of delay before clearing txwake

	goto main_loop						; lather, rinse, repeat

	end									; we'll never hit this because we loop forever
