...
; This is a PIC based keyer.  Currently supported devices are the 16F84, 16F84A, 16F628, and 16F628A although memory limits on
...
check_dah_buffer
	...
	ifdef include_iambic_b_code
	btfsc iambic_b_mode	
	btfsc dah				; is dah pressed ?   ; TODO - an ifdef after this btfsc probably breaks iambic B
	endif
	ifdef include_txwake_line_code
	bsf txwake
	endif
